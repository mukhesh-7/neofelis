...
const ShaderBackground = ({ className }: ShaderBackgroundProps) => {
  ...
  `;
    ...
    const vec4 lineColor = vec4(1.0, 0.85, 0.3, 1.0);
    ...
    void main() {
      ...
      vec4 lines = vec4(0.0);
      vec4 bgColor1 = vec4(0.15, 0.1, 0.02, 1.0);
      vec4 bgColor2 = vec4(0.25, 0.18, 0.05, 1.0);
  ...
  `;
    ...
    useEffect(() => {
        ...
        const resizeCanvas = () => {
            // Adjust flexibility: use parent container dimenstions if we want it to fit absolute
